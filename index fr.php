        ...
        foreach ($show as $result) {
            ...
            if ($result['type']) {
                ...
                <form action="" method="post">
                    ...
                    if ($i <= count($time)) {
                        echo'<button type="submit" name="add" class="aclear">Ajouter</button>';
                    } else {
                        echo'<button class="daclear" disabled>Ajouter</button>';
                    }
                    echo'<a class="cnslbtn">Annuler</a>
                    </form>
                </div>
                </table>
                <div>
                    <a href="show fr.php?id='.$result['id'].'" class="more">Montre plus</a>';
                    if ($chec->rowCount()>0) {
                        if ($stat->stat == 1 || $stat->stat == 2) {
                            echo'<a class="more" id="rndv">Réservation</a>';
                        }else {
                            echo'<a class="dmore">Réservation</a>';
                        }
                    }else {
                        echo'<a class="dmore">Réservation</a>';
                    }
