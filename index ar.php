            ...
            if ($result['type']) {
                ...
                <form action="" method="post">
                    ...
                    if ($i <= count($time)) {
                        ...
                        echo"<div class='time'>لقد نفدت الأماكن</div>";
                    }
                    echo'<div id="dadd">
                    ...
                    if ($i <= count($time)) {
                        echo'<button type="submit" name="add" class="aclear">إضافة</button>';
                    } else {
                        echo'<button class="daclear" disabled>إضافة</button>';
                    }
                    echo'<a class="cnslbtn">إلغاء</a>
                    </form>
                </div>
                </table>
                <div>
                    ...
                    if ($chec->rowCount()>0) {
                        if ($stat->stat == 1 || $stat->stat == 2) {
                            echo'<a class="more" id="rndv">حجز</a>';
                        }else {
                            echo'<a class="dmore">حجز</a>';
                        }
                    }else {
                        echo'<a class="dmore">حجز</a>';
                    }
