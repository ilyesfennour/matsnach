    ...
    <section style="display: flex;flex-wrap: wrap;justify-content: center;">
        ...
        foreach ($show as $result) {
            ...
            if ($result['type']) {
                ...
                echo'<table class="tab">
                    ...
                    if ($chec->rowCount()>0) {
                        ...
                        if ($stat->stat == 0) {
                            ...
                            echo'<td class="td1" rowspan="2" style="color: red;"><div class="lite" style="background-color: red;"></div>Stopped</td></tr>';
                        }
                    }else {
                        echo'<td class="td1" rowspan="2" style="color: gray;"><div class="lite" style="background-color: gray;"></div>Closed</td></tr>';
                    }
                ...
                echo'</table>
                <a href="show more.php?id='.$result['id'].'" class="more" data-id="'.$result['id'].'">Show more</a>
            </div>
            ';
        }
        ?>
        ...
        <div class="mfadd">
            <form action="" method="post" id="fadd" enctype="multipart/form-data">
                ...
                <div id="cadd" class="in16">
                    ...
                    <span class="sp">Time for each customer</span><br>
                </div>
