...
if (isset($_POST['add'])) {
    ...
    if ($add->execute()) {
        header("location:show more fr.php?id=$p_id",true);
    }
}
if (isset($_POST['clr'])) {
...
if (isset($_POST['del'])) {
    ...
    $del->bindParam('p_id',$p_id);
    if ($del->execute()) {
        header("location:add fr.php",true);
    }
}
if (isset($_POST['op'])) {
...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    <style>
        ...
        .in:focus ~ .spn2,.in:not(:placeholder-shown) ~ .spn2{
    ...
    <section>
        <div class="content">
            ...
            foreach ($show as $result) {
                ...
                echo'<div class="gr1"><span class="sp">Prénom: </span><input type="text" name="" id="in" value="'.$result['f_name'].'" disabled><img src="img/icons8-edit-50.png" alt="" class="edit"></div>
                <div class="gr2"><span class="sp">Nom: </span><input type="text" name="" id="in" value="'.$result['l_name'].'" disabled><img src="img/icons8-edit-50.png" alt="" class="edit"></div>
                <div class="gr3"><span class="sp">Début du travail: </span><input type="text" name="" id="in" value="'.$result['sw'].'" disabled><img src="img/icons8-edit-50.png" alt="" class="edit"></div>
                <div class="gr4"><span class="sp">Fin du travail: </span><input type="text" name="" id="in" value="'.$result['bs'].'" disabled><img src="img/icons8-edit-50.png" alt="" class="edit"></div>
                <div class="gr5"><span class="sp">Début de pause: </span><input type="text" name="" id="in" value="'.$result['ew'].'" disabled><img src="img/icons8-edit-50.png" alt="" class="edit"></div>
                <div class="gr6"><span class="sp">Fin de pause: </span><input type="text" name="" id="in" value="'.$result['be'].'" disabled><img src="img/icons8-edit-50.png" alt="" class="edit"></div>';
                if ($result['su']) {
                    echo'<div class="gr8"><span class="sp">Dimanche</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }else{
                    echo'<div class="gr8"><span class="nsp">Dimanche</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }
                if ($result['mo']) {
                    echo'<div class="gr9"><span class="sp">Lundi</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }else{
                    echo'<div class="gr9"><span class="nsp">Lundi</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }
                if ($result['tu']) {
                    echo'<div class="gr10"><span class="sp">Mardi</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }else{
                    echo'<div class="gr10"><span class="nsp">Mardi</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }
                if ($result['we']) {
                    echo'<div class="gr11"><span class="sp">Mercredi</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }else{
                    echo'<div class="gr11"><span class="nsp">Mercredi</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }
                if ($result['th']) {
                    echo'<div class="gr12"><span class="sp">Jeudi</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }else{
                    echo'<div class="gr12"><span class="nsp">Jeudi</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }
                if ($result['fr']) {
                    echo'<div class="gr13"><span class="sp">Vendredi</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }else{
                    echo'<div class="gr13"><span class="nsp">Vendredi</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }
                if ($result['sa']) {
                    echo'<div class="gr14"><span class="sp">Samedi</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }else{
                    echo'<div class="gr14"><span class="nsp">Samedi</span><img src="img/icons8-edit-50.png" alt="" class="edit1"></div>';
                }
                echo'<div class="gr15"><span class="sp">Adresse: </span><input type="text" name="" id="bin" value="'.$result['adress'].'" disabled><img src="img/icons8-edit-50.png" alt="" class="edit"></div>
                <div class="gr16"><span class="sp">Métier: </span><input type="text" name="" id="bin" value="'.$result['job'].'" disabled><img src="img/icons8-edit-50.png" alt="" class="edit"></div>
                <div class="gr17"><span class="sp">Téléphone: </span><input type="text" name="" id="in" value="'.$result['fone'].'" disabled><img src="img/icons8-edit-50.png" alt="" class="edit"></div>
                <div class="gr18"><span class="sp">Temps pour chaque client: </span><input type="text" name="" id="in" value="'.$result['tpc'].'" disabled><img src="img/icons8-edit-50.png" alt="" class="edit"></div>
                <div class="gr19"><span class="sp">Le prix: </span><input type="text" name="" id="in" value="'.$result['prix'].'" disabled><img src="img/icons8-edit-50.png" alt="" class="edit"></div>
                
                <div class="mfadd">
                    <form action="" method="post" id="fadd" enctype="multipart/form-data">
                        <h1 class="h">Modifier la clinique</h1>
                        ...
                        echo'<div id="cadd" class="in16">
                            ...
                            <span class="spn2">Temps pour chaque client</span><br>
                        </div>
                        <div id="cadd" class="in17">
                            <input type="number" name="prix" class="in" placeholder="" value="'.$result['prix'].'">
                            <span class="spn">Le prix</span><br>
                        </div>
                        <button name="editbtn" class="btn">Modifier</button>
        ...
        <div class="chaine">
            ...
            if ($chec->rowCount()>0) {
                ...
                if ($stat->stat == 0) {
                    echo'<div class="prbtn"><button type="submit" id="op" name="op" class="pb">Ouvrir</button>
                    <button type="submit" id="ps" name="ps" class="pb">Pause</button>
                    <button type="submit" id="cl" name="cl" class="bpb">Fermer</button></div>
                </form>';
                }
                if ($stat->stat == 1) {
                    echo'<div class="prbtn"><button type="submit" id="op" name="op" class="bpb">Ouverte</button>
                    <button type="submit" id="ps" name="ps" class="pb">Pause</button>
                    <button type="submit" id="cl" name="cl" class="pb">Fermer</button></div>
                </form>';
                }
                if ($stat->stat == 2) {
                    echo'<div class="prbtn"><button type="submit" id="op" name="op" class="pb">Ouvrir</button>
                    <button type="submit" id="ps" name="ps" class="bpb">On pause</button>
                    <button type="submit" id="cl" name="cl" class="pb">Fermer</button></div>
                </form>';
                }
            } else {
                echo'<div class="prbtn"><button type="submit" id="op" name="op" class="pb">Ouvrir</button>
                <button type="submit" id="ps" name="ps" class="dpb" disabled>Pause</button>
                <button type="submit" id="cl" name="cl" class="dpb" disabled>Fermer</button></div>
            </form>';
            }
            ...
            foreach ($show as $result) {
                ...
                <form action="" method="post">
                    <div class="nbr">Patient N°: '.$i.'</div>';
                    if ($i <= count($time)) {
                        echo'<div class="time">Heure d\'arrivée estimée: '.$time[$i - 1].'</div>';
                    } else {
                        echo"<div class='time'>Je n'ai plus d'endroits</div>";
                    }
                    echo'<div id="dadd">
                        <input type="text" name="fname" class="n1in" required placeholder="">
                        <span class="spn1">Prénom</span><br>
                    </div>
                    <div id="dadd">
                        <input type="text" name="lname" class="n1in" required placeholder="">
                        <span class="spn1">Nom</span><br>
                    </div>
                    <button type="submit" name="add" class="aclear">Ajouter</button>
                    <a class="cnslbtn">Annuler</a>
                    </form>
                </div>';
            }
            ?>
        <div id="msg">
            ...
            <a class="cnslbtn">Annuler</a>
            <form action="" method="post">
                <button type="submit" name="clr" class="clear">Effacer</button>
            </form>
        </div>
        <div id="msg1">
            <p>Êtes-vous sûr de vouloir supprimer votre clinique?</p>
            <a class="cnslbtn">Annuler</a>
            <form action="" method="post">
                <button type="submit" name="del" class="clear">Supprimer</button>
            </form>
        </div>
    </section>
</body>
