    ...
    <section>
        ...
        <div class="sec">
            <form action="" method="post" class="box">
                ...
                <?php
                    echo'
                        <span class="text">First Name:</span><input type="text" placeholder="'.$_SESSION['user']->f_name.'" class="name" name="fname" required><br>
                        <span class="text">Last Name:</span><input type="text" placeholder="'.$_SESSION['user']->l_name.'" class="name" name="lname" required><br>
                        <span class="text">Password:</span><input type="password" placeholder="'.$_SESSION['user']->password.'" class="name" name="pass" required><br>
                        <span class="text">Confirm Password:</span><input type="password" placeholder="'.$_SESSION['user']->password.'" class="name" name="cpass" required><br>
                        <button type="submit" id="btn" name="btn">Edit</button>
                        <a href="index.php" id="cbtn">Cancel</a>
                        ';
                ?>
            </form>
        </div>
