    ...
    <section style="display: flex;flex-wrap: wrap;justify-content: center;">
        ...
        foreach ($show as $result) {
            ...
            if ($result['type']) {
                ...
                echo'</table>
                <a href="show more ar.php?id='.$result['id'].'" class="more" data-id="'.$result['id'].'">المزيد</a>
            </div>
            ';
        }
        ?>
