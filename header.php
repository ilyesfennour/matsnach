            ...
            <div id="c-menu">
                ...
                <?php
                    ...
                    if(isset($_SESSION['user'])){
                        echo '<div id="p-menu"><a href="account.php" id="login">'.$_SESSION['user']->f_name.'</a></div>';                
                    }else{
                        echo '<a href="login.php" id="login">Login</a>';
                    }
                ?> 
                <a href="index.php" class="el">Home</a>
                <a href="favorit.php" class="el">My doctor</a>
                <a href="add.php" class="el">Add clinic</a>
                ...
                <a href="account.php" class="el">Edit account</a>
                <form action="" method="post"><input type="submit" value="sign out" name="exit" class="el"></form>
                <a href="icons.php" class="el">Our icons</a>
            </div>
            <div class="pr">
                <a class="n"><img src="img/menu.png" alt="" class="s-menu" ></a>
                <a href="index.php" class="n"><img src="img/home page.png" alt="" class="bok"></a>
                <a href="favorit.php" class="n"><img src="img/icons8-bookmark-30.png" alt="" class="bok"></a>
            </div>
            <div class="search">
                <label for="search"><img src="img/loupe.png" alt="" class="lp"></label>
                <input type="search" placeholder="search" name="search" id="search" oninput="document.getElementById('sr-close').style.display='block'">
...
<script>
    ...
    function displayNames(value) {
        window.location = 'index.php?sr='+value;
        input.value = value;
        removeElements();
    }
