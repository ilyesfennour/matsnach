            ...
            <div id="c-menu">
                ...
                <?php
                    ...
                    if(isset($_SESSION['user'])){
                        echo '<div id="p-menu"><a href="account fr.php" id="login">'.$_SESSION['user']->f_name.'</a></div>';                
                    }else{
                        echo '<a href="login fr.php" id="login">connexion</a>';
                    }
                ?> 
                <a href="index fr.php" class="el">Acceuil</a>
                <a href="favorit fr.php" class="el">Mon docteur</a>
                <a href="add fr.php" class="el">Ajouter une clinique</a>
                ...
                <a href="account fr.php" class="el">Modifier le compte</a>
                <form action="" method="post"><input type="submit" value="se déconnecter" name="exit" class="el"></form>
                <a href="icons fr.php" class="el">Nos icônes</a>
            </div>
            <div class="pr">
                <a class="n"><img src="img/menu.png" alt="" class="s-menu"></a>
                <a href="index fr.php" class="n"><img src="img/home page.png" alt="" class="bok"></a>
                <a href="favorit fr.php" class="n"><img src="img/icons8-bookmark-30.png" alt="" class="bok"></a>
            </div>
            <div class="search">
                <label for="search"><img src="img/loupe.png" alt="" class="lp"></label>
                <input type="search" placeholder="chercher" name="search" id="search" oninput="document.getElementById('sr-close').style.display='block'">
...
<script>
    ...
    function displayNames(value) {
        window.location = 'index fr.php?sr='+value;
        input.value = value;
        removeElements();
    }
